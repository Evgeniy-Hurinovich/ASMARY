...
export const bookings = [
  // CABIN 001
  {
    ...
    hasBreakfast: true,
    observations:
      'У меня аллергия на глютен, и я хотел бы заказать безглютеновый завтрак.',
    isPaid: false,
    numGuests: 1,
  },
  {
  ...
  },
  {
    ...
    guestId: 9,
    hasBreakfast: false,
    observations: 'Мы возьмем с собой нашу маленькую собаку.',
    isPaid: true,
    numGuests: 3,
  },
  {
  ...
  // CABIN 006
  {
    ...
    hasBreakfast: false,
    observations:
      'Мы будем поздно заселяться, около полуночи. Надеюсь, это нормально :)',
    isPaid: true,
    numGuests: 6,
  },
  {
